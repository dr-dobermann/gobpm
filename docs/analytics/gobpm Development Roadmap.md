...
- **C1 Core flow** ✅ — None Start/End, Terminate End; Manual Task; Exclusive and Parallel gateways, Service/User tasks, sequence-flow conditions.
