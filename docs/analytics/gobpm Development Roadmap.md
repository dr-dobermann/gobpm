...
- **BPMN elements:** Inclusive / Complex / Event-Based gateways; Manual / Script / Business-Rule tasks; Call Activity, (Embedded/Transaction/Event/Ad-hoc) Sub-Process; Signal/Error/Escalation/Conditional/Compensation/Link/Terminate event behavior; multi-instance & loop execution — all absent or skeleton. (**Send / Receive tasks and Message throw/catch + start events have landed** — SRD-013/014/015.)
- **Messaging runtime:** Send/Receive tasks + Message throw/catch events (SRD-013/014, ADR-014 Accepted) and **Message-Start event-triggered instantiation + key-based correlation** (SRD-015, ADR-015/016 Accepted — phase-2a/2b) have landed. Deferred: conversation-token threading (phase-2c), context-based/predicate correlation (phase-3), Event-Based-gateway start, durable subscriptions.
