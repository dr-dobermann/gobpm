...
- **BPMN elements:** Inclusive / Complex / Event-Based gateways; Manual / Script / Business-Rule tasks; Call Activity, (Embedded/Transaction/Event/Ad-hoc) Sub-Process; Error/Escalation/Conditional/Compensation/Link/Terminate event behavior; multi-instance & loop execution — all absent or skeleton. (**Send / Receive tasks, Message throw/catch + start events, and Signal events** — throw/catch/broadcast + signal-start instantiation — **have landed** — SRD-013/014/015/026.)
