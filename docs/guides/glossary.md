...
| **Snapshot / launch template** | The immutable, validated form a process is frozen into at registration. Every instance clones it; the header (id/name, properties, correlation keys) is shared by reference. It is *not* a durable persistence mechanism — see [design ADR-009](../design/). |
