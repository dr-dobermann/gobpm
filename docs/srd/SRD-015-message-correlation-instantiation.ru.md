...
- **Долговечные подписки / персистентность** между перезапусками; **качество брокера** TTL / dead-letter / упорядочивание (брокер / ADR Distribution & Scale). Буфер придержанных сообщений остаётся ограниченным + pull-on-subscribe (ADR-015 §2.5).
