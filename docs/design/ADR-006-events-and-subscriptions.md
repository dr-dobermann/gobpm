...
delivery is accepted** (ADR-025 v.3 §2.13) — a point-to-point message with no
subscriber is dropped, not queued. With each execution registering as itself
