...
будущий ADR Distribution & Scale). Два свойства держатся независимо от
брокера:
...
оператора. Проектирование этих ручек — дело брокера (ADR-002 / ADR Distribution & Scale), а не
...
- **Гарантии межэкземплярной доставки, упорядочивание, dead-letter** — заботы
  качества брокера (ADR-002 / ADR Distribution & Scale).
