...
const (
	...
	// The GlobalTask family: a callable declared once at definitions level
	// and invoked through a callActivity. Each imports as a process of its
	// own (ADR-024 v.7 §2.13).
	tagGlobalTask             = "globalTask"
	tagGlobalManualTask       = "globalManualTask"
	tagGlobalUserTask         = "globalUserTask"
	tagGlobalScriptTask       = "globalScriptTask"
	tagGlobalBusinessRuleTask = "globalBusinessRuleTask"
