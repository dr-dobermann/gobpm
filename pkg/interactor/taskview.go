...
// NO task data: iteration variables must not reach the distributor before an
...
type TaskInfo struct {
	...
	// (ADR-020 v.2 §2.7). It carries no iteration data — only the identifiers that
	...
	// Priority is BPMN's taskPriority iteration attribute (Table 10.14), reported
