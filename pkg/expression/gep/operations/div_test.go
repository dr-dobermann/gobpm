...
var divTests = []testCase{
	{vars.Int, 8, vars.Int, 2, "x", vars.Values{I: 4}, shouldPass},
	{vars.Int, 8, vars.Int, 0, "x", vars.Values{I: 4}, shouldFail},
	{vars.Int, 5, vars.Bool, false, "x", vars.Values{I: -1}, shouldFail},
	{vars.Int, 10, vars.String, "2", "x", vars.Values{I: 5}, shouldPass},
	{vars.Int, 5, vars.String, "trash", "x", vars.Values{I: -1}, shouldFail},
	{vars.Int, 50, vars.Float, -10.0, "x", vars.Values{I: -5}, shouldPass},
	{vars.Int, 50, vars.Float, 0, "x", vars.Values{I: -5}, shouldFail},
	...
	{vars.Float, 7.7, vars.Int, 11, "x", vars.Values{F: 7.7 / 11}, shouldPass},
	{vars.Float, 7.7, vars.Int, 0, "x", vars.Values{F: 7.7 / 11}, shouldFail},
	...
	{vars.Float, 7.7, vars.Float, 7.9, "x", vars.Values{F: 7.7 / 7.9}, shouldPass},
	{vars.Float, 7.7, vars.Float, 0.0, "x", vars.Values{F: 7.7 / 7.9}, shouldFail},
